...
const synthesis_1 = require("../services/synthesis");
...
router.get('/', async (req, res) => {
    try {
        ...
        const queryEmbedding = await (0, embedding_1.embedText)(q);
    ...
    `;
        ...
        const recentSources = await prisma_1.default.source.findMany({
        ...
        const answer = await (0, synthesis_1.synthesizeAnswer)(q, combinedSources);
